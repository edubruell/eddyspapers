...
export default function ResultCard({ paper }) {
    ...
    return (
        ...
        >
                        ...
                        {copied ? (
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                ...
                                <path fillRule="evenodd"
                                      d="M16.704 5.29a1 1 0 0 1 .006 1.414l-7.5 7.6a1 1 0 0 1-1.436 0l-3.5-3.543a1 1 0 1 1 1.424-1.404l2.782 2.816 6.784-6.88a1 1 0 0 1 1.44-.003Z"
                                      clipRule="evenodd" />
                            </svg>
                        ) : (
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                            ...
                            {expanded ? (
                                ...
                                <path
                                    d="M6.5 10a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Zm6 0a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Zm4.5 1.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3Z"
                                />
                            )}
                        </svg>
            ...
            {expanded && (
                <HandleDetail handle={paper.Handle} />
            )}
        </article>
    );
}
