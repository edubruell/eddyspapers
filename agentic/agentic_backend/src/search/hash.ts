...
// in backend/R/api.R). Raw comma-strings are hashed as received, not the split arrays.
...
// (mirrors save_person_search in backend/R/persons.R, distinct from the person *log* hash).
